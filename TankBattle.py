...
maxapple = random.randint(12,15)
apple=[]

    
for app in range (maxapple):
    apple.append(Apple("health.gif","red",random.randint(-360,370),random.randint(-360,370)))
...
missile1= Missile1("fire1.gif", "yellow", 0, 0)
missile2= Missile2("fire1.gif", "blue", 0, 0)
...
turtle.onkey(missile1.fire, "/")
turtle.onkey(missile2.fire, "space")
...
while True:
    ...
    for enemy in enemies:
        ...
        if missile1.is_collision(enemy):
            ...
            enemy.goto(x, y)
            winsound.PlaySound("ghost.wav", winsound.SND_ASYNC)
    ...
    for app in range (maxapple):
        if player1.is_collision(apple[app]):
           apple[app].setposition(1000,1000)
           player1.health+=30
           life1.update_lives1()
        ...
        if player2.is_collision(apple[app]):
           apple[app].setposition(1000,1000)
           player2.health+=30
           life2.update_lives2()
           winsound.PlaySound("health.wav", winsound.SND_ASYNC)
